...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002000458103').split()]
...
URL = "https://vj-filter-bot-fx7t.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-fx7t.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-bot-fx7t.onrender.com".format(FQDN)
else:
    URL = "https://vj-filter-bot-fx7t.onrender.com".format(FQDN)
